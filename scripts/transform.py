...
# 1. Cargar ambos archivos (Asumiendo que son CSV)
...
# 2. Unirlos para tener el >1M de registros
df_full = df_train.union(df_test)

# 3. Transformación básica: Contar palabras y limpiar
...
def process_batch_data():
    ...
    # Juntamos train y test para superar el millón de registros
    df_full = df_train.union(df_test)

    print("3. Generando nuevas columnas (Feature Generation)...")
    # Limpiamos nulos y creamos columnas útiles para el dashboard
